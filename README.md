...
This is based on my [PythonTeamsPresence](https://github.com/poiriersimon/PythonTeamsPresence)

Authentication is handled via [device flow authentication](#device-flow-authentication), the recommended approach for PiBusyLight. If you're looking for examples of how to work with Microsoft Graph from Python _web applications_, see [Python authentication samples for Microsoft Graph](https://github.com/microsoftgraph/python-sample-auth). 
...
1. Go to [Controlling Multiple LEDs With Python and Your Raspberry Pi's GPIO Pins](https://www.instructables.com/id/Controlling-Multiple-LEDs-With-Python-and-Your-Ras/) and do the Step 1 and 2
...
* [Controlling Multiple LEDs With Python and Your Raspberry Pi's GPIO Pins](https://www.instructables.com/id/Controlling-Multiple-LEDs-With-Python-and-Your-Ras/)
* [PythonTeamsPresence](https://github.com/poiriersimon/PythonTeamsPresence)